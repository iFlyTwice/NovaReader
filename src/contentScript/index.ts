...
class ExtensionController {
  ...
  constructor() {
    ...
    // Add font styles to ensure they load before any UI components
  ...
  /**
   * Helper method to safely remove document click listener
   */
  ...
  /**
   * Helper method to create the document click listener
   */
  private createVoiceSelectorClickListener(): void {
