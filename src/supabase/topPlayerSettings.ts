/**
 * Functions for managing top player visibility settings with Supabase
 */
...
/**
 * Update the top player visibility setting in the user preferences object
 * This should be called before saving user preferences with saveUserPreferences
 */
export const includeTopPlayerInPreferences = (preferences: any, isVisible: boolean): any => {
  if (!preferences) {
    preferences = {};
  }
  
  // Add or update the top player visibility setting
  preferences.topPlayerEnabled = isVisible;
